# Dictionary for kpv — mul

This repository contains source files for a dictionary from Komi-Zyrian to Multiple languages. The content is licensed under the CC-BY-4.0 license.
